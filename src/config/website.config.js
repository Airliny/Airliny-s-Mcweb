...
export const websiteConfig = {
  ...
  site: {
    title: "GA服",
    description: "欢迎来到GA服，探索无限可能的方块世界！",
    ...
    items: [
      {
        ...
        pageTitle: {
          // 主标题配置（支持打字机效果）
          mainTitle: {
            texts: ["欢迎来到 GA服", "Welcome to GA server"], // 多语言标题数组
            typewriter: {
